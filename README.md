...
### Токен
* Токен доступа, токен пользователя и ID группы хранится в файте TOKEN_ID.py

### Старт общения с ботом
* Для начала разговора с ботом, пнеобходимо написать написать сообщение "Start", "Старт", "Начать". На другое сообщение бот ответит подсказкой.
